package doyoung.practice.busan
...
import doyoung.practice.busan.databinding.ActivityMainBinding
import okhttp3.*
...
class MainActivity : AppCompatActivity() {
    ...
    fun assignValuesFromVoiceInput(input: String) {
        ...
        if (busNumber != "시티투어 4번") {
            println("현재는 시티투어 4번에 대한 서비스만을 진행합니다, 추후 지원 노선을 확대할 예정입니다.")
            lineId = "5290205000"
        } else {
            lineId = "5290205000"
        }
